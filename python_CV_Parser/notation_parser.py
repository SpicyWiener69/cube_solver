...
class NotationConvertor:
    ...
    def __init__(self, cubesize = 3):
        self.cubesize = cubesize
        self.Dim = DIM_CLASSES[cubesize]

    def verify_notations(self, notations):
        valid_dict = {
            3: [
    ...
    def notations_to_dataclasses(self,notations:list): #->list[NotationDataClass]
        dataclasses = []
    ...
    def notations_to_modified_notations(self,dataclasses):
        ...
        for dataclass in dataclasses:
            ...
            if dataclass.name == 'D':
                core_move = [NotationDataClass(
                                            ...
                                            layerdepth = self.cubesize - dataclass.layerdepth #TODO: testing
                                            )]
            else:
    ...
    def remove_repetitions(self, modified_dataclasses):    #->list[NotationDataClass]
        cleaned_dataclasses = []
        i = 0
    ...
    def notation_to_clean_dataclasses(self,notations):
        steps = [
                self.verify_notations,\
                self.notations_to_dataclasses, \
                self.notations_to_modified_notations,\
...
if __name__ == "__main__":
    DEBUG = 1
    notationconverter = NotationConvertor()
    notations = ['U','F2']
    notationconverter.notation_to_clean_dataclasses(notations)